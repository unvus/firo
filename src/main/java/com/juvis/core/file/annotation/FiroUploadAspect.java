package com.juvis.core.file.annotation;

import com.juvis.core.file.util.FiroUtil;
import com.juvis.core.file.util.FiroWebUtil;
import com.juvis.core.file.module.service.domain.AttachContainer;
...
public class FiroUploadAspect {
    ...
    @Around("execution(public * *(.., @com.juvis.core.file.annotation.FiroUpload (*), ..)) && args(domain, ..)")
